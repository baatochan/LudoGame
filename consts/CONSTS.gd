...
const MIN_START_GAME_WAIT_TIMER = 0.1
const MAX_START_GAME_WAIT_TIMER = 0.2
const MIN_ROLL_WAIT_TIMER = 0.1
const MAX_ROLL_WAIT_TIMER = 0.2
const MIN_MOVE_WAIT_TIMER = 0.1
const MAX_MOVE_WAIT_TIMER = 0.2
